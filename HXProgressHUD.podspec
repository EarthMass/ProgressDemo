#
#  Be sure to run `pod spec lint HXProgressHUD.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "mars" => "627556038@qq.com" }
  # Or just: s.author    = "mars"
  # s.authors            = { "mars" => "627556038@qq.com" }
  # s.social_media_url   = "http://twitter.com/mars"
